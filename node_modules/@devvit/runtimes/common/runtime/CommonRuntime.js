...
import { resolveActorHostname, resolvePluginDefinitionHostname, resolveSystemHostname, RUNTIME_CNAME, SUPERVISOR_CNAME, } from '../../lib/HostnameUtil.js';
...
export class CommonRuntime {
    ...
    start() {
        ...
        this.loadPlugins(__classPrivateFieldGet(this, _CommonRuntime_dispatcher, "f"));
