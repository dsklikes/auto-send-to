...
export declare abstract class CommonRuntime implements CommonRuntimeLike, WorkerPathResolver, RuntimeActor, Inspector, EnvelopeDispatcher {
     ...
     */
    protected abstract loadPlugins(dispatcher: CentralDispatcher): void;
    /**
     ...
     */
    bindRemoteActor(definitions: Definition[], hostname: string, url: string, extraOutgoingMetadata?: Metadata): void;
    /**
