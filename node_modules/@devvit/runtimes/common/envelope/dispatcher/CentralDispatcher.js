...
import { Hostname, parentHostname, resolveSystemHostname, SUPERVISOR_CNAME, } from '../../../lib/HostnameUtil.js';
import { Log } from '../../../lib/loggers/Log.js';
import { assertEnvelopePostable, envelopeMethod, EnvelopeUtil } from '../EnvelopeUtil.js';
...
_CentralDispatcher_clients = new WeakMap(), _CentralDispatcher_recipientsByHostname = new WeakMap(), _CentralDispatcher_supervisor = new WeakMap(), _CentralDispatcher_streamsByID = new WeakMap(), _CentralDispatcher_instances = new WeakSet(), _CentralDispatcher_bind = function _CentralDispatcher_bind(recipient) {
        ...
        if (recipient != null) {
            try {
                ...
                if (!isDispatcherErrorEnvelope(envelope))
                    __classPrivateFieldGet(this, _CentralDispatcher_instances, "m", _CentralDispatcher_dispatchFiltered).call(this, this, __classPrivateFieldGet(this, _CentralDispatcher_instances, "m", _CentralDispatcher_newServiceUnavailableError503).call(this, envelope));
            }
            return;
        }
    ...
    if (stream != null) {
        try {
            ...
            if (!isDispatcherErrorEnvelope(envelope))
                __classPrivateFieldGet(this, _CentralDispatcher_instances, "m", _CentralDispatcher_dispatchFiltered).call(this, this, __classPrivateFieldGet(this, _CentralDispatcher_instances, "m", _CentralDispatcher_newClientCloseRequestError499).call(this, envelope));
        }
    }
...
}, _CentralDispatcher_newClientCloseRequestError499 = function _CentralDispatcher_newClientCloseRequestError499(envelope) {
    const destination = envelope.src;
    ...
    return Envelope.fromPartial({
        ...
        complete: true,
        dst: destination,
        message: Error('500 filter error.', 
        // @ts-expect-error
        { cause: error }),
        metadata: filterHeadersForDestination(this, envelope.metadata, destination),
        method: envelope.method,
...
}, _CentralDispatcher_newServiceUnavailableError503 = function _CentralDispatcher_newServiceUnavailableError503(envelope) {
    const destination = envelope.src;
    return Envelope.fromPartial({
        id: UUIDv4(),
        complete: true,
...
function isDispatcherErrorEnvelope(envelope) {
    return (envelope.message instanceof Error &&
        envelope.complete === true &&
        /^\d\d\d/.test(envelope.message.message) &&
