...
import { envelopeAsError, envelopeMethod, extractMetadataTraceID, requestMessageToJSON, responseMessageFromJSON, sendEnvelopeMessageToStream, } from './EnvelopeUtil.js';
...
_EnvelopeClient_idFactory = new WeakMap(), _EnvelopeClient_dispatcher = new WeakMap(), _EnvelopeClient_callbacksByStreamID = new WeakMap(), _EnvelopeClient_logger = new WeakMap(), _EnvelopeClient_instances = new WeakSet(), _EnvelopeClient_createAsyncMethod = function _EnvelopeClient_createAsyncMethod(definition, method) {
    ...
    reqStream.subscribe({
        ...
        error: (error) => __classPrivateFieldGet(this, _EnvelopeClient_instances, "m", _EnvelopeClient_postDispatcher).call(this, { ...envelope, complete: true, message: error, success: false }),
