...
export function envelopeAsError(envelope) {
    // to-do: this could be a string or any other type. We should try harder
    // to stringify this. Additionally, CentralDispatcher intentionally emits
    // Envelopes containing Errors. If the system can't handle that, we
    // shouldn't. Grep for instanceof error. See also EnvelopeServer.
