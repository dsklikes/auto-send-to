...
import { envelopeMethod, requestMessageFromJSON, responseMessageToJSON, sendEnvelopeMessageToStream, } from './EnvelopeUtil.js';
/**
...
_EnvelopeServer_dispatcher = new WeakMap(), _EnvelopeServer_requestStreamsById = new WeakMap(), _EnvelopeServer_responseStreamsById = new WeakMap(), _EnvelopeServer_actor = new WeakMap(), _EnvelopeServer_id = new WeakMap(), _EnvelopeServer_idFactory = new WeakMap(), _EnvelopeServer_methodsByName = new WeakMap(), _EnvelopeServer_logger = new WeakMap(), _EnvelopeServer_instances = new WeakSet(), _EnvelopeServer_handleAsync = async function _EnvelopeServer_handleAsync(method, req, definition) {
    ...
    try {
        ...
        __classPrivateFieldGet(this, _EnvelopeServer_instances, "m", _EnvelopeServer_postDispatcher).call(this, { ...envelope, message: StringUtil.caughtToString(err) });
    }
...
async function _EnvelopeServer_handleSink(method, req, definition) {
    ...
    catchError(async (err) => {
        ...
        .subscribe({
        next: (message) => __classPrivateFieldGet(this, _EnvelopeServer_instances, "m", _EnvelopeServer_postDispatcher).call(this, {
            ...envelope,
            complete: false,
            message: responseMessageToJSON(message, definition),
            success: true,
        }),
        error: (err) => __classPrivateFieldGet(this, _EnvelopeServer_instances, "m", _EnvelopeServer_postDispatcher).call(this, { ...envelope, complete: true, message: err, success: false }),
        complete: () => __classPrivateFieldGet(this, _EnvelopeServer_instances, "m", _EnvelopeServer_postDispatcher).call(this, { ...envelope, complete: true, message: undefined, success: true }),
    });
