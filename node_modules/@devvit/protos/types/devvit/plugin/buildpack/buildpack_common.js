...
function createBaseBundle() {
    return { code: "", dependencies: undefined, assets: undefined, buildInfo: undefined };
}
export const Bundle = {
    ...
    toJSON(message) {
        ...
        message.dependencies !== undefined &&
            (obj.dependencies = message.dependencies ? DependencySpec.toJSON(message.dependencies) : undefined);
        message.assets !== undefined && (obj.assets = message.assets ? FileSystem.toJSON(message.assets) : undefined);
...
function createBaseCompileParams() {
    return { virtualFileSystem: undefined, filename: undefined, minify: 0, includeAssets: false, info: undefined };
}
export const CompileParams = {
    ...
    toJSON(message) {
        const obj = {};
        message.virtualFileSystem !== undefined &&
            (obj.virtualFileSystem = message.virtualFileSystem ? FileSystem.toJSON(message.virtualFileSystem) : undefined);
        message.filename !== undefined && (obj.filename = message.filename);
        message.minify !== undefined && (obj.minify = minifyToJSON(message.minify));
        message.includeAssets !== undefined && (obj.includeAssets = message.includeAssets);
        message.info !== undefined && (obj.info = message.info ? ActorSpec.toJSON(message.info) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseCompileParams();
...
export const CompileLog = {
    ...
    toJSON(message) {
        ...
        message.detail !== undefined &&
            (obj.detail = message.detail ? CompileLogLineDetail.toJSON(message.detail) : undefined);
