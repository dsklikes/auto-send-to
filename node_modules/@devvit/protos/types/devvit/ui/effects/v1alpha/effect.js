...
(function (EffectType) {
    ...
    EffectType[EffectType["EFFECT_VIEW_THING"] = 5] = "EFFECT_VIEW_THING";
...
export const Effect = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.viewThing !== undefined) {
    ...
    fromJSON(object) {
        return {
            ...
            viewThing: isSet(object.viewThing) ? ViewThingEffect.fromJSON(object.viewThing) : undefined,
    ...
    toJSON(message) {
        ...
        message.viewThing !== undefined &&
            (obj.viewThing = message.viewThing ? ViewThingEffect.toJSON(message.viewThing) : undefined);
    ...
    fromPartial(object) {
        ...
        message.showToast = (object.showToast !== undefined && object.showToast !== null)
            ...
            : undefined;
        message.viewThing = (object.viewThing !== undefined && object.viewThing !== null)
            ? ViewThingEffect.fromPartial(object.viewThing)
            : undefined;
