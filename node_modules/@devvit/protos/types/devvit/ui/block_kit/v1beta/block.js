...
export const BlockConfig_Spacer = {
    ...
    fromJSON(object) {
        return { size: isSet(object.size) ? blockSpacerSizeFromJSON(object.size) : undefined };
    },
    toJSON(message) {
        const obj = {};
        message.size !== undefined &&
...
function createBaseBlockConfig_Icon() {
    return { icon: "", color: undefined, size: undefined };
}
