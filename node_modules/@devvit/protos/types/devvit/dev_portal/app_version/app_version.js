...
import { AppVersionInfo, installationTypeFromJSON, installationTypeToJSON, OptionalVersionVisibility, versionVisibilityFromJSON, versionVisibilityToJSON, } from './info/app_version_info.js';
...
function createBaseAppVersionUpdateRequest() {
    return { id: "", visibility: undefined, isTrusted: undefined, validInstallTypes: [], about: undefined };
}
export const AppVersionUpdateRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            isTrusted: isSet(object.isTrusted) ? Boolean(object.isTrusted) : undefined,
            validInstallTypes: Array.isArray(object?.validInstallTypes)
                ? object.validInstallTypes.map((e) => installationTypeFromJSON(e))
                : [],
    ...
    toJSON(message) {
        ...
        message.isTrusted !== undefined && (obj.isTrusted = message.isTrusted);
        if (message.validInstallTypes) {
            obj.validInstallTypes = message.validInstallTypes.map((e) => installationTypeToJSON(e));
        }
        else {
