    ...
    readonly methods: {
        ...
        readonly listAutomations: {
            ...
            readonly responseType: {
                ...
                } & { [K_6 in Exclude<keyof I, "$type" | "automations">]: never; }>(object: I_5): AutomationList;
            };
            readonly responseStream: false;
            readonly options: {};
        };
        ...
        readonly updateAutomation: {
            ...
            readonly requestType: {
                ...
                fromPartial<I_6 extends {
                    ...
                    location?: string | undefined;
                } & { [K_5 in Exclude<keyof I, "$type" | keyof UpdateAutomationRequest>]: never; }>(object: I_6): UpdateAutomationRequest;
            };
            readonly requestStream: false;
            readonly responseType: {
                ...
                fromPartial<I_7 extends {} & {} & { [K in Exclude<keyof I_7, "$type">]: never; }>(_: I_7): Empty;
            };
            readonly responseStream: false;
            readonly options: {};
        };
            ...
            readonly responseType: {
                ...
                fromPartial<I_9 extends {
                    ...
                    fields?: ({
                        ...
                        prompt?: string | undefined;
                        response?: string | undefined;
                    } & { [K_1 in Exclude<keyof I_9["fields"][number], "$type" | keyof import("../../user_configurable/user_configurable.js").ConfigField>]: never; })[] & { [K_2 in Exclude<keyof I_9["fields"], "$type" | keyof {
                        fieldType?: import("../../user_configurable/user_configurable.js").ConfigFieldType | undefined;
                        key?: string | undefined;
                        prompt?: string | undefined;
                        response?: string | undefined;
                    }[]>]: never; }) | undefined;
                } & { [K_3 in Exclude<keyof I_9, "fields" | "$type">]: never; }>(object: I_9): ConfigForm;
            };
            readonly responseStream: false;
            readonly options: {};
        };
