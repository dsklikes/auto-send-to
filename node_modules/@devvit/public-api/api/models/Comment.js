...
export class Comment {
    constructor(data, metadata) {
        ...
        __classPrivateFieldSet(this, _Comment_replies, __classPrivateFieldGet(Comment, _a, "m", _Comment_getCommentsListing).call(Comment, {
    ...
    async delete() {
        return Comment.delete(this.id, __classPrivateFieldGet(this, _Comment_metadata, "f"));
    }
    async edit(options) {
    ...
    async approve() {
        await Comment.approve(this.id, __classPrivateFieldGet(this, _Comment_metadata, "f"));
    ...
    async remove(isSpam = false) {
        await Comment.remove(this.id, isSpam, __classPrivateFieldGet(this, _Comment_metadata, "f"));
    ...
    async lock() {
        await Comment.lock(this.id, __classPrivateFieldGet(this, _Comment_metadata, "f"));
        __classPrivateFieldSet(this, _Comment_locked, true, "f");
    }
    async unlock() {
        await Comment.unlock(this.id, __classPrivateFieldGet(this, _Comment_metadata, "f"));
    ...
    async distinguish(makeSticky = false) {
        const { distinguishedBy, stickied } = await Comment.distinguish(this.id, makeSticky, false, __classPrivateFieldGet(this, _Comment_metadata, "f"));
    ...
    async distinguishAsAdmin(makeSticky = false) {
        const { distinguishedBy, stickied } = await Comment.distinguish(this.id, makeSticky, true, __classPrivateFieldGet(this, _Comment_metadata, "f"));
        __classPrivateFieldSet(this, _Comment_distinguishedBy, distinguishedBy, "f");
        __classPrivateFieldSet(this, _Comment_stickied, stickied, "f");
    }
    async undistinguish() {
        const { distinguishedBy, stickied } = await Comment.undistinguish(this.id, __classPrivateFieldGet(this, _Comment_metadata, "f"));
        __classPrivateFieldSet(this, _Comment_distinguishedBy, distinguishedBy, "f");
        __classPrivateFieldSet(this, _Comment_stickied, stickied, "f");
    }
    static async getById(id, metadata) {
        ...
        if (!response.data?.children.length || !response.data.children[0].data) {
    ...
    static getComments(options, metadata) {
        ...
        return __classPrivateFieldGet(Comment, _a, "m", _Comment_getCommentsListing).call(Comment, {
    ...
    static getCommentsByUser(options, metadata) {
        ...
        return new Listing({
            ...
            async fetch(fetchOptions) {
                ...
                const children = response.data.children.map((child) => new Comment(child.data, metadata));
                return {
                    children,
...
_a = Comment, _Comment_id = new WeakMap(), _Comment_authorName = new WeakMap(), _Comment_body = new WeakMap(), _Comment_createdAt = new WeakMap(), _Comment_parentId = new WeakMap(), _Comment_postId = new WeakMap(), _Comment_replies = new WeakMap(), _Comment_approved = new WeakMap(), _Comment_edited = new WeakMap(), _Comment_locked = new WeakMap(), _Comment_removed = new WeakMap(), _Comment_stickied = new WeakMap(), _Comment_spam = new WeakMap(), _Comment_distinguishedBy = new WeakMap(), _Comment_numReports = new WeakMap(), _Comment_collapsedBecauseCrowdControl = new WeakMap(), _Comment_score = new WeakMap(), _Comment_permalink = new WeakMap(), _Comment_metadata = new WeakMap(), _Comment_getCommentsListing = function _Comment_getCommentsListing(options, metadata, depthOffset = 0) {
    return new Listing({
        limit: options.limit,
        pageSize: options.pageSize,
        fetch: async (fetchOptions) => {
            ...
            if (fetchOptions.more) {
                if (fetchOptions.more.children.length) {
                    ...
                    const { children } = __classPrivateFieldGet(Comment, _a, "m", _Comment_buildCommentsTree).call(Comment, response.json.data.things, options.postId, options, metadata);
            ...
            return __classPrivateFieldGet(Comment, _a, "m", _Comment_buildCommentsTree).call(Comment, responseChildren, commentId ?? options.postId, options, metadata, depthOffset);
        },
    });
    ...
    for (const child of redditObjects) {
        ...
        if (child.kind === 't1') {
            ...
            __classPrivateFieldSet(comment, _Comment_replies, __classPrivateFieldGet(Comment, _a, "m", _Comment_getCommentsListing).call(Comment, {
                ...options,
            ...
            if ('replyList' in child.data && child.data.replyList?.data) {
                const { children, more } = __classPrivateFieldGet(Comment, _a, "m", _Comment_buildCommentsTree).call(Comment, child.data.replyList.data.children, comment.id, options, metadata, depthOffset);
                if (children.length) {
