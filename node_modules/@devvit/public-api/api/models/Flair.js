...
export class FlairTemplate {
    ...
    async delete() {
        return FlairTemplate.deleteFlairTemplate(__classPrivateFieldGet(this, _FlairTemplate_id, "f"), __classPrivateFieldGet(this, _FlairTemplate_subredditName, "f"), __classPrivateFieldGet(this, _FlairTemplate_metadata, "f"));
    }
    ...
    static async createPostFlairTemplate(options, metadata) {
        return __classPrivateFieldGet(FlairTemplate, _a, "m", _FlairTemplate_createOrUpdateFlairTemplate).call(FlairTemplate, { ...options, flairType: FlairType.Post }, metadata);
    }
    static async createUserFlairTemplate(options, metadata) {
        return __classPrivateFieldGet(FlairTemplate, _a, "m", _FlairTemplate_createOrUpdateFlairTemplate).call(FlairTemplate, { ...options, flairType: FlairType.User }, metadata);
    }
    static async editFlairTemplate(editOptions, metadata) {
        return __classPrivateFieldGet(FlairTemplate, _a, "m", _FlairTemplate_createOrUpdateFlairTemplate).call(FlairTemplate, editOptions, metadata);
    }
...
export class Flair {
    static setUserFlair(options, metadata) {
        return __classPrivateFieldGet(Flair, _b, "m", _Flair_setFlair).call(Flair, options, metadata);
    }
    static setPostFlair(options, metadata) {
        return __classPrivateFieldGet(Flair, _b, "m", _Flair_setFlair).call(Flair, {
            ...options,
            postId: asT3ID(options.postId),
        }, metadata);
    }
    static async removePostFlair(subredditName, postId, metadata) {
        return __classPrivateFieldGet(Flair, _b, "m", _Flair_removeFlair).call(Flair, subredditName, postId, undefined, metadata);
    }
    static async removeUserFlair(subredditName, username, metadata) {
        return __classPrivateFieldGet(Flair, _b, "m", _Flair_removeFlair).call(Flair, subredditName, undefined, username, metadata);
    }
}
